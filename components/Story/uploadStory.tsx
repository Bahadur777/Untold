          ...
          <div className="flex flex-col items-center">
            ...
            <form className="w-full max-w-lg">
              <div className="flex flex-col gap-4">
                <input className="border-b-2 border-blue-600 px-4 py-2 text-lg text-blue-900 placeholder-gray-500 focus:outline-none focus:border-blue-700 transition duration-300" type="text" name="name" placeholder="Title" value={formData.name} onChange={handleChange} />
