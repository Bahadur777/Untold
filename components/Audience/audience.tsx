  ...
  return (
    <div className="pt-[1rem] pb-[1rem] bg-gradient-to-br from-blue-400 to-purple-500 min-h-screen flex flex-col justify-center items-center">
      <div className="max-w-lg w-full p-8 bg-white rounded-lg shadow-lg">
        <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-6">Welcome to Untold 📚</h2>
        <hr className="border-t-2 border-gray-300 mb-4" />
        <p className="text-lg text-gray-700 mb-6">Untold is a platform designed for avid readers, aspiring writers, and storytellers from all around the world 🌍.</p>
        <hr className="border-t-2 border-gray-300 mb-4" />
        ...
        <hr className="border-t-2 border-gray-300 mb-4" />
        <p className="text-lg text-gray-700 mb-6">Through untold, users can discover a diverse range of stories, connect with other enthusiasts, and unleash their own storytelling potential 🚀.</p>
        <hr className="border-t-2 border-gray-300 mb-4" />
        ...
        <hr className="border-t-2 border-gray-300 mb-4" />
        <p className="text-lg text-gray-700 mb-6">Once you have experienced the world of Untold, we encourage you to take action by exploring our collection of stories, sharing your own stories, and engaging with our vibrant community 🌟.</p>
